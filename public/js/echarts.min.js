				...
				return e.m = t, e.c = i, e.p = "", e(0)
						...
						function u(t, e) {
							...
							e[i ? "eachComponent" : "eachSeries"](function (t, a) {
								...
								var s = a.id + "_" + a.type,
									l = o[s];
								if (!l) {
									var u = M.parseClassType(a.type),
										h = i ? I.getClass(u.main, u.sub) : A.getClass(u.sub);
									if (!h) return;
						...
						function m(t, e) {
							...
							var n = +t.get("progressive"),
								o = i > t.get("progressiveThreshold") && n && !x.node;
									...
									/* 	ECharts, a javascript interactive chart library.
										...
										var j = r.prototype; j._onframe = function () {
											...
											if (this[W] = !0, !this._model || e) {
												var n = new S(this._api),
													o = this._theme,
													r = this._model = new _(null, null, o, n);
											...
											if (x.canvasSupported) {
												...
												if (nt[e]) {
													...
													P.each(it, function (o, h) {
														if (o.group === e) {
															var c = o.getRenderedCanvas(P.clone(t)),
												...
												if (e) {
													...
													if (a.isSingleCanvas && a.isSingleCanvas()) o.configLayer(0, {
														...
														r.colorStops || r.image ? (o.configLayer(0, {
															clearColor: r
														}), this[Z] = !0, this._dom.style.background = "transparent") : (this[Z] && o.configLayer(0, {
															clearColor: null
														}), this[Z] = !1, this._dom.style.background = r)
													}
												}
											},
										...
										var X = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout", "contextmenu"]; j._initEvents = function () {
											E(X, function (t) {
										...
										var Y = [], $ = {}, Q = [], K = [], J = [], tt = {}, et = {}, it = {}, nt = {}, ot = new Date - 0, rt = new Date - 0, at = "_echarts_instance_", st = {
											...
											var n = P.isObject(t) ? t.type : [t, t = {
												event: e
											}][0];
											t.event = (t.event || n).toLowerCase(), e = t.event, Y[n] || (Y[n] = {
												action: i,
												actionInfo: t
											}), $[e] = n
											...
											"function" == typeof t && (e = t, t = V), J.push({
												prio: t,
												func: e,
												isLayout: !0
											})
										}, st.registerVisual = function (t, e) {
											"function" == typeof t && (e = t, t = G), J.push({
												prio: t,
												func: e
											})
										...
										var lt = M.parseClassType; st.extendComponentModel = function (t, e) {
											var i = M;
											if (e) {
												var n = lt(e);
										...
										l.normalizeToArray = function (t) {
											...
											function i(t, e, i) {
												for (var n = 0, o = t.length; n < o; n++)
													for (var r = t[n].seriesId, a = l.normalizeToArray(t[n].dataIndex), s = i && i[r], u = 0, h = a.length; u < h; u++) {
														var c = a[u];
										...
										var x = {
												...
												axisLabel: function () {
													...
													if (r) {
														...
														g = g * v / 180;
														for (var y = o(e, g, e.labelDirection), x = i.get("data"), b = [], w = a(i), S = i.get("triggerEvent"), M = 0; M < f.length; M++)
															if (!_(s, M, e.labelInterval)) {
																var T = c;
																x && x[M] && x[M].textStyle && (T = new h(x[M].textStyle, c, i.ecModel));
																var I = T.getTextColor() || i.get("axisLine.lineStyle.color"),
																	A = s.dataToCoord(f[M]),
																	L = [A, e.labelOffset + e.labelDirection * d],
											...
											if (x) {
												...
												if (!C) {
													...
													var W = function (t, e) {
															...
															if (0 !== n)
																if (E = (e - I[i]) / n, v)
																	if (N = A[i], R = A[0 === i ? i : i - 1], V = A[i > x - 2 ? x - 1 : i + 1], B = A[i > x - 3 ? x - 1 : i + 2], w) h(R, N, V, B, E, E * E, E * E * E, d(t, o), T);
																	else {
																		var l;
										...
										function l(t, e, i) {
											...
											return e && (f.shape[a ? "width" : "height"] = 0, y.initProps(f, {
												shape: {
													width: u,
													height: h
												}
										...
										function f(t, e) {
											...
											if (i && i.length && t.count()) {
												...
												if (n && "cartesian2d" === e.type) {
													...
													var h = l[0],
														c = l[l.length - 1],
														f = h.interval ? d(h.interval[0], s) : h.value,
														p = c.interval ? d(c.interval[1], s) : c.value,
														g = p - f;
													...
													for (var o = 0; o < l.length; o++)
														if (l[o].interval) {
															...
															u.push({
																...
																offset: (d(l[o].interval[1], s) - f) / g,
																color: l[o].color
															})
														} else u.push({
															offset: (l[o].value - f) / g,
															color: l[o].color
														});
													var m = new y.LinearGradient(0, 0, 0, 0, u, (!0)),
														v = e.getAxis(a),
														x = v.toGlobalCoord(v.dataToCoord(f)),
														_ = v.toGlobalCoord(v.dataToCoord(p));
										...
										t.exports = b.extend({
											...
											_updateAnimation: function (t, e, i, n, o) {
												var r = this._polyline,
													a = this._polygon,
													s = t.hostModel,
													l = v(this._data, t, this._stackedOnPoints, e, this._coordSys, i),
													u = l.current,
													h = l.stackedOnCurrent,
													d = l.next,
													f = l.stackedOnNext;
												o && (u = c(l.current, i, o), h = c(l.stackedOnCurrent, i, o), d = c(l.next, i, o), f = c(l.stackedOnNext, i, o)), r.shape.__points = l.current, r.shape.points = u, y.updateProps(r, {
													shape: {
														points: d
													}
												}, s), a && (a.setShape({
										...
										function a(t, e) {
											...
											if (n) {
												var r = e || 0 === n[0] && 100 === n[1],
													a = !e && l.getPixelPrecision(o, [0, 500]),
													s = !(e || a < 20 && a >= 0),
													u = e || r || s;
										...
										i(214), i(215), i(2).registerAction({
											type: "showTip",
											event: "showTip",
											update: "none"
										...
										function u(t, e, i, n, o, r, a) {
											var u = a.getWidth(),
												h = a.getHeight(),
												c = r && r.getBoundingRect().clone();
											if (r && c.applyTransform(r.transform), "function" == typeof t && (t = t([e, i], o, n.el, c)), f.isArray(t)) e = v(t[0], u), i = v(t[1], h);
										...
										i(2).extendComponentView({
												...
												if (t.from !== this.uid) {
													...
													if (null == t.x || null == t.y) {
														if (n || e.eachSeries(function (t) {
															...
															var r = n.getData(),
																a = m.queryDataIndex(r, t);
															if (null == a || f.isArray(a)) return;
															var s, l, u = r.getItemGraphicEl(a),
											...
											_showAxisTooltip: function (t, e, i) {
												...
												f.each(this._seriesGroupByAxis, function (t) {
													...
													var p = !1,
														g = this._lastHover;
													if ("cross" === r) n(g.data, h) && (p = !0), g.data = h;
													else {
														var m = f.indexOf(l, d);
											...
											_showPolarPointer: function (t, e, i, n) {
												...
												if ("cross" === u) r("angle", n, c.getExtent()), r("radius", n, h.getExtent()), this._updateCrossText(e, n, t);
												else {
											...
											_dispatchAndShowSeriesTooltipContent: function (t, e, i, n, o, r) {
												...
												if (c.payloadBatch && !o && d.dispatchAction({
													...
													if (o) u(r || a.get("position"), i[0], i[1], this._tooltipContent, p, null, d);
													else {
											...
											_showTooltipContent: function (t, e, i, n, o, r, a, s, l) {
												if (this._ticket = "", t.get("showContent") && t.get("show")) {
													...
													var d = e;
													if (c)
														if ("string" == typeof c) d = p.formatTpl(c, i);
													...
													if (r) {
														...
														if (m && !n && ($.copy(e), $.applyTransform(m), e = $), n) a = e.x, l = e.y;
															...
															var v = o.textPosition,
																y = o.textDistance;
															if (v instanceof Array) a = e.x + O(v[0], e.width), l = e.y + O(v[1], e.height), u = u || "left", d = d || "top";
															else {
										...
										function r(t, e, i) {
											...
											for (var r = t.targetVisuals[i], a = l.prepareVisualTypes(r), s = {}, u = 0, h = a.length; u < h; u++) {
												var c = a[u],
													d = r["colorAlpha" === c ? "__alphaForOpacity" : c];
										...
										var n = i(2),
											o = i(1);
										i(266), i(267), i(276), n.registerProcessor(i(269)), n.registerVisual(o.curry(i(46), "graph", "circle", null)), n.registerVisual(i(270)), n.registerVisual(i(273)), n.registerLayout(i(277)), n.registerLayout(i(271)), n.registerLayout(i(275)), n.registerCoordinateSystem("graphView", {
											create: i(272)
										})
									}, function (t, e, i) {
										"use strict";
										...
										for (var n = i(2), o = i(78), r = function () {}, a = ["treemapZoomToNode", "treemapRender", "treemapMove"], s = 0; s < a.length; s++) n.registerAction({
											type: a[s],
											update: "updateView"
										}, r);
										n.registerAction({
										...
										"use strict";
										i(216), i(318), i(337), i(2).extendComponentView({
											type: "polar"
										})
									}, function (t, e, i) {
										i(373), i(374), i(336)
										...
										function o(t) {
											...
											for (var i = -(1 / 0), n = 0; n < t.length; n++)
												for (var o = t[n].interval, r = t[n].close, a = 0; a < 2; a++) o[a] < i && (o[a] = i, r[a] = 1 - a), i = o[a]
										}
										var r = i(231),
											a = i(1),
											s = i(71),
														...
														if (null != t.label && (n.text = t.label), t.hasOwnProperty("value")) {
															...
															for (var r = n.interval = [], l = n.close = [0, 0], u = [1, 0, 1], h = [-(1 / 0), 1 / 0], c = [], d = 0; d < 2; d++) {
																for (var f = [
																		["gte", "gt", "min"],
																		["lte", "lt", "max"]
																	][d], p = 0; p < 3 && null == r[d]; p++) r[d] = t[f[p]], l[d] = u[p], c[d] = 2 === p;
																null == r[d] && (r[d] = h[d])
															}
										...
										t.exports = function (t) {
											"" === t.map && t.regions.push(new n("南海诸岛", r, o))
										}
									}, function (t, e, i) {
										var n = i(1),
											o = {
